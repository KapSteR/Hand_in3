	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.menu_fragment_container) != null) {
			...
			getSupportFragmentManager()
					.beginTransaction()
					.add(R.id.menu_fragment_container, new MenuFragment(),
							"menuFragment").commit();

			if (isDualPane) {
				getSupportFragmentManager()
						.beginTransaction()
						.add(R.id.content_fragment_container_large,
								new ContentFragment(), "contentFragment")
						.commit();
			}
		}
	}
