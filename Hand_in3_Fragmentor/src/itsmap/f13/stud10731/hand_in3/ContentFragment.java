...
public class ContentFragment extends Fragment {
    ...
    //Saving text, (because I can), so textView is not cleared when orientation changed. 
	//(Could also have been implemented, by making sure that fragment is not recreated on change.)
	@Override
